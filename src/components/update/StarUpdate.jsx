...
import { InboxOutlined } from '@ant-designicons';
...
const StarUpdate = () = {
  ...
  const fetchStars = async () = {
    try {
      const response = await axios.get('httpsstardb-api.onrender.comapistarscreate-starget-all-star');
  ...
  const onFinish = async (values) = {
    ...
    try {
      const response = await axios.put(
        `httpsstardb-api.onrender.comapistarscreate-starupdate-star${selectedStar._id}`,
        formData,
        {
          headers {
        ...
        Form.Item
          ...
          Dragger
            ...
            p className=ant-upload-drag-icon
              InboxOutlined 
            p
            p className=ant-upload-textClick or drag file to this area to uploadp
          Dragger
        Form.Item
        Form.Item
          name=starcover
