...
const CreateImages = () => {
  ...
  const fetchStars = async (searchQuery = '') => {
    try {
      const response = await axios.get(`https://stardatabase-api-production.up.railway.app/api/stars/create-star/get-all-star?search=${searchQuery}`);
  ...
  const onFinish = async (values) => {
    ...
    try {
      const response = await axios.post(
        'https://stardatabase-api-production.up.railway.app/api/stars/images/create-star-images',
        formData,
        {
          headers: {
