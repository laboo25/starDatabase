...
const CreateStarBio = () => {
  ...
  useEffect(() => {
    axios.get('star-database-api.vercel.app/api/stars/create-star/get-all-star')
      .then(response => {
  ...
  const handleSubmit = () => {
    ...
    axios.post('star-database-api.vercel.app/api/stars/star-bio/create-star-bio', starData)
      .then(response => {
