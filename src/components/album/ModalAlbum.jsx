...
const ModalAlbum = ({ visible, albumname, length, images, onClose, albumId, sortField, sortOrder }) => {
  ...
  const saveTags = async () => {
    ...
    try {
      ...
      await axios.put(`star-database-api.vercel.app/api/stars/albums/update/${albumId}`, {
        albumname,
  ...
  const handleEditAlbum = async () => {
    try {
      ...
      await axios.put(`star-database-api.vercel.app/api/stars/albums/update/${albumId}`, formData, {
        headers: {
